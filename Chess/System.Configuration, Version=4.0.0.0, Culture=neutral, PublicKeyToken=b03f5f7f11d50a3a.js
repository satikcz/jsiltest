...
(function ConfigurationElement$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, "DeserializePropertyValue", 
      new JSIL.MethodSignature($.Object, [$asm03.TypeRef("System.Configuration.ConfigurationProperty"), $asm09.TypeRef("System.Xml.XmlReader")])
    );
...
(function ErrorInfoXmlDocument$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:false}, "CreateSectionXmlNode", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Xml.XmlNode"), [$asm03.TypeRef("System.Configuration.ConfigXmlReader")])
    );
