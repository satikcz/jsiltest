    ...
    public static class Page {
        ...
        public static bool InitGL () {
            ...
            if (Builtins.IsTruthy(gl)) {
                ...
                dynamic alert = Builtins.Global["alert"];
        ...
        //    if (!compileStatus) {
        //        dynamic alert = Builtins.Global["alert"];
        //        alert(GL.getShaderInfoLog(shaderObject));
        //        return null;
        //    }
        ...
        public static dynamic CompileShader(string divName)
        {
            var extension = Path.GetExtension(divName).ToLower();
            ...
            //var shaderText = File.ReadAllText(filename);
            var shaderText = element.InnerHTML;
        ...
        public static void InitTexture () {
            ...
            try {
                ...
                dynamic jsil = Builtins.Global["JSIL"];
                var objectUrl = jsil.GetObjectURLForBytes(imageBytes, "image/png");
        ...
        public static void Tick () {
            dynamic animFrame = Builtins.Global["requestAnimFrame"];
            animFrame((Action)Tick);
            HandleKeys();
            DrawScene();
            Animate();
        }
